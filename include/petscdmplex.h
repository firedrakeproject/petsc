...
PETSC_EXTERN PetscErrorCode DMPlexCreateReferenceCellByType(MPI_Comm, DMPolytopeType, DM *);
...
PETSC_EXTERN PetscErrorCode DMPlexWrite_gmfMesh2d(DM, PetscBool, const char[], const char[], PetscInt, Vec *,  PetscInt *, const char * [], PetscSection, PetscBool);
PETSC_EXTERN PetscErrorCode DMPlexWrite_gmfMesh2d_1sol(DM, PetscBool, const char [], const char [], Vec, PetscInt, const char [], PetscSection, PetscBool);
PETSC_EXTERN PetscErrorCode DMPlexWrite_gmfMesh2d_noSol(DM, const char [], const char [], PetscSection, PetscBool);
PETSC_EXTERN PetscErrorCode DMPlexCreateGmfFromFile_2d(const char [], const char [], DM *);
PETSC_EXTERN PetscErrorCode DMPlexReadGmfSolFromFile_2d(DM, PetscSection, const char [], PetscInt, Vec *);
//
PETSC_EXTERN PetscErrorCode DMPlexWrite_gmfMesh3d(DM, PetscBool, const char[], const char[], PetscInt, Vec *,  PetscInt *, const char * [], PetscSection, PetscBool);
PETSC_EXTERN PetscErrorCode DMPlexWrite_gmfMesh3d_1sol(DM, PetscBool, const char [], const char [], Vec, PetscInt, const char [], PetscSection, PetscBool);
...
PETSC_EXTERN PetscErrorCode DMPlexCellRefinerRefine(DMPlexCellRefiner, DMPolytopeType, PetscInt *, DMPolytopeType *[], PetscInt *[], PetscInt *[], PetscInt *[]);
