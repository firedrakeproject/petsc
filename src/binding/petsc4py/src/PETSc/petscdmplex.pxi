...
cdef extern from * nogil:
    ...
    int DMPlexCreateFromFile(MPI_Comm,const char[],const char[],PetscBool,PetscDM*)
    ...
    int DMPlexMetricRestrictAnisotropyFirst(PetscDM,PetscBool*)
    int DMPlexMetricSetNoInsertion(PetscDM,PetscBool)
    int DMPlexMetricNoInsertion(PetscDM,PetscBool*)
    int DMPlexMetricSetNoSwapping(PetscDM,PetscBool)
    ...
    int DMPlexMetricGetNumIterations(PetscDM,PetscInt*)
    int DMPlexMetricSetMinimumMagnitude(PetscDM,PetscReal)
    int DMPlexMetricGetMinimumMagnitude(PetscDM,PetscReal*)
    int DMPlexMetricSetMaximumMagnitude(PetscDM,PetscReal)
    int DMPlexMetricGetMaximumMagnitude(PetscDM,PetscReal*)
    int DMPlexMetricSetMaximumAnisotropy(PetscDM,PetscReal)
    int DMPlexMetricGetMaximumAnisotropy(PetscDM,PetscReal*)
    int DMPlexMetricSetTargetComplexity(PetscDM,PetscReal)
    int DMPlexMetricGetTargetComplexity(PetscDM,PetscReal*)
    int DMPlexMetricSetNormalizationOrder(PetscDM,PetscReal)
